M:compactflash
F:G$cfInit$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$cfWaitIdle$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$cfWaitCommandReady$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$cfWaitDataReady$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$cfReadSector$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$cfTest$0_0$0({3}DF,SV:S),Z,0,0,0,0,0
S:Lcompactflash.cfReadSector$status$1_0$19({1}SC:U),R,0,0,[r5]
S:Lcompactflash.cfReadSector$i$1_0$19({2}SI:U),E,0,0
S:Lcompactflash.cfReadSector$idx$1_0$19({2}SI:U),R,0,0,[]
S:Lcompactflash.cfInit$device$1_0$7({1}SC:U),F,0,0
S:Lcompactflash.cfWaitIdle$device$1_0$9({1}SC:U),F,0,0
S:Lcompactflash.cfWaitCommandReady$device$1_0$12({1}SC:U),F,0,0
S:Lcompactflash.cfWaitDataReady$device$1_0$15({1}SC:U),F,0,0
S:Lcompactflash.cfReadSector$buf$1_0$18({3}DG,SC:U),F,0,0
S:Lcompactflash.cfReadSector$sectorCount$1_0$18({2}SI:U),F,0,0
S:Lcompactflash.cfReadSector$device$1_0$18({1}SC:U),F,0,0
S:Lcompactflash.cfTest$buf$1_0$22({3}DG,SC:U),F,0,0
S:Lcompactflash.cfTest$device$1_0$22({1}SC:U),F,0,0
