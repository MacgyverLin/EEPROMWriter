M:main
F:G$SysCopyBIOS$0_0$0({3}DF,SV:S),C,0,0,0,0,0
F:G$SysCheckBIOS$0_0$0({3}DF,SC:U),C,0,0,0,0,0
F:G$SysClearMemory$0_0$0({3}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({3}DF,SV:S),C,0,0,0,0,0
S:G$data_v$0_0$0({1}SC:U),E,0,0
S:G$p0$0_0$0({2}DX,SC:U),E,0,0
S:G$fp$0_0$0({3}DG,DF,SC:U),E,0,0
S:G$idata_v$0_0$0({1}SC:U),G,0,0
S:G$bvar$0_0$0({1}SB0$1:U),H,0,0
S:G$pdata_v$0_0$0({1}SC:U),P,0,0
S:G$xdata_v$0_0$0({1}SC:U),F,0,0
S:G$p1$0_0$0({1}DD,SC:U),F,0,0
S:G$p4$0_0$0({3}DG,SC:U),F,0,0
S:G$p5$0_0$0({3}DG,SC:U),F,0,0
S:G$chksum$0_0$0({2}SI:U),F,0,0
S:G$PORTA_8255$0_0$0({1}SC:U),F,0,0
S:Lmain.SysCopyBIOS$dstAddr$1_0$2({2}SI:U),F,0,0
S:Lmain.SysCopyBIOS$size$1_0$2({2}SI:U),F,0,0
S:Lmain.SysCopyBIOS$srcAddr$1_0$2({2}SI:U),F,0,0
S:Lmain.SysCheckBIOS$dstAddr$1_0$5({2}SI:U),F,0,0
S:Lmain.SysCheckBIOS$size$1_0$5({2}SI:U),F,0,0
S:Lmain.SysCheckBIOS$srcAddr$1_0$5({2}SI:U),F,0,0
S:Lmain.SysClearMemory$size$1_0$8({2}SI:U),F,0,0
S:Lmain.SysClearMemory$address$1_0$8({2}SI:U),F,0,0
S:Lmain.main$i$1_0$11({1}SC:U),F,0,0
...
S:G$SysCopyBIOS$0_0$0({3}DF,SV:S),C,0,0
S:G$SysCheckBIOS$0_0$0({3}DF,SC:U),C,0,0
S:G$SysClearMemory$0_0$0({3}DF,SV:S),C,0,0
S:G$main$0_0$0({3}DF,SV:S),C,0,0
S:G$code_v$0_0$0({1}SC:U),D,0,0
S:G$p2$0_0$0({2}DX,SC:U),D,0,0
S:G$p3$0_0$0({2}DC,SC:U),D,0,0
